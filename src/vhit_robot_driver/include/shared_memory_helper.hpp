...
class SharedMemoryArea
{
  public:
    SharedMemoryArea(
      std::shared_ptr<comm::datalayer::DatalayerSystem> datalayerSystem,
      std::shared_ptr<comm::datalayer::IClient> client,
      std::string address)
    : datalayerSystem_(std::move(datalayerSystem)),
  ...
  private:
    ...
    std::shared_ptr<comm::datalayer::DatalayerSystem> datalayerSystem_;
    std::shared_ptr<comm::datalayer::IClient> client_;
    std::string address_;
